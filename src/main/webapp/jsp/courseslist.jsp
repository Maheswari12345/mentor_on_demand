...
<body class="bg">
        ...
        <ul class="ul"> 
                ...
                <li class="li"><a href="/addcourses" class="hyperlink">Add Courses</a></li>
...
<%
List courseslist=(List)request.getAttribute("courseslist");
...
%>
  ...
  <table id="customers">
      ...
      <% for(int i=0;i<courseslist.size();i++){
	       Courses e=(Courses)courseslist.get(i);
	       %>
       <tr>
          <td><%= e.getId()%></td>
          <td><a href="#" class="link-dec"><%= e.getCoursesName()%></a></td>
